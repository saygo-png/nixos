...
from PyQt5.QtWidgets import (
  QDockWidget, QScrollArea, QSizePolicy, QToolButton, QVBoxLayout, QWidget
)
  ...
  def resizeToView(self):
    ...
    if view:
      ...
      if isinstance(self.widget, ntScrollAreaContainer):
        ...
        if view.height(
        ) < containerSize.height() + self.btnHide.height() + 14 + self.scrollBarMargin():
          containerSize.setHeight(
            view.height() - self.btnHide.height() - 14 - self.scrollBarMargin()
          )
