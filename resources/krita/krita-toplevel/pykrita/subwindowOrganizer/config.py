...
SPLITMODERANGE = [
  0.3, 0.6
] #will enter split mode if cursor on the left or right of workspace, and height between 30% and 60% of the canvas. Enter impossible range like [1,0] to fully disable splitting
